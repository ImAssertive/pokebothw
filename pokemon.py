...
class pokeCog:
    ...
    async def infoMainMenu(self, ctx, menu, result):
            ...
            embed.set_footer(text="Page (1/4)     bot made by Zootopia#0001")
    ...
    async def infoMainMenuPage2(self, ctx, menu, result):
            ...
            embed.set_footer(text="Page (2/4)     bot made by Zootopia#0001")
    ...
    async def infoMainMenuPage3(self, ctx, menu, result):
            ...
            embed.set_footer(text="Page (3/4)      bot made by Zootopia#0001")
    ...
    async def infoMainMenuPage4(self, ctx, menu, result):
            ...
            embed.set_footer(text="Page (4/4)     bot made by Zootopia#0001")
